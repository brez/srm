...
What follows is primarily traks that were tested in front of a live audience / legit sound system in one form or another. You want to confirm two things: 1) the crowd seems to moving / keeping up with the changes  2) the trak itself sounds good on a live PA. Get the 2nd one right and you can almost guarantee the 1st.
        ...
        <p>
 Drum and Bass is interesting music because it pushes the contradictions of dancibility and complexity.. it takes your mind on an elated journey of limitless direction while holding your body close enough to the beat to still shake your ass, the Divine Duality. 
        </p>
        <p class="important" style="width: 500px; text-align: center">
          <img src='images/dubplates3.png'/>
        </p>
        <p>
          Of course some of these dubplates made it onto vinyl, i.e. early editions of eventual records.
        </p>
      </div>
      <div id="traks">
        <table>
